  ...
  return (
    <>
      ...
      <section className="bg-background py-24 lg:py-32 relative overflow-hidden">
        ...
        <AbstractDeco src="/Abstract elements/Leaf1.svg" className="-right-16 bottom-10 w-[280px] h-[280px] lg:w-[350px] lg:h-[350px]" opacity={0.9} style={{ transform: 'rotate(-25deg)' }} />
        <AbstractDeco src="/Abstract elements/Teal shape 2.svg" className="-left-40 -top-32 w-[500px] h-[500px]" opacity={0.9} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-16 items-start">
            ...
            <FadeUp delay={0.2}>
              <div className="relative mx-auto lg:mx-0">
                <AbstractDeco src="/Abstract elements/Brown shape 2.svg" className="-right-12 -bottom-12 w-[300px] h-[300px]" opacity={0.9} />
      ...
      <section className="bg-card py-24 lg:py-32 relative overflow-hidden">
        ...
        <AbstractDeco src="/Abstract elements/Brown shape 1.svg" className="-right-28 top-1/4 w-[350px] h-[350px]" opacity={0.9} />
        <AbstractDeco src="/Abstract elements/Teal shape 1.svg" className="-left-32 -bottom-20 w-[400px] h-[400px]" opacity={0.9} />
      ...
      <section className="bg-background py-24 lg:py-32 relative overflow-hidden">
        ...
        <AbstractDeco src="/Abstract elements/Leaf2.svg" className="-left-16 top-1/3 w-[250px] h-[250px]" opacity={0.9} style={{ transform: 'rotate(25deg)' }} />
      ...
      <section className="py-20 lg:py-28 relative overflow-hidden" style={{ background: 'linear-gradient(170deg, hsl(175 30% 92%) 0%, hsl(40 30% 97%) 50%, hsl(40 30% 97%) 100%)' }}>
        <AbstractDeco src="/Abstract elements/Brown shape 2.svg" className="-right-20 -top-10 w-[300px] h-[300px]" opacity={0.9} style={{ transform: 'rotate(30deg)' }} />
      ...
      <section className="relative overflow-hidden py-24 lg:py-28 px-6" style={{ background: 'hsl(175 35% 55%)' }}>
        ...
        <AbstractDeco src="/Abstract elements/Leaf1.svg" className="-left-20 -top-16 w-[300px] h-[300px]" opacity={0.12} style={{ transform: 'rotate(-15deg)', filter: 'brightness(0) invert(1)' }} />
        <AbstractDeco src="/Abstract elements/Teal shape 1.svg" className="-right-16 -bottom-20 w-[350px] h-[350px]" opacity={0.08} style={{ filter: 'brightness(0) invert(1)' }} />

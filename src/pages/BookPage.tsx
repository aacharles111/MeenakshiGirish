  ...
  return (
    <>
      ...
      <section className="bg-background py-24 lg:py-32 relative overflow-hidden">
        <AbstractDeco src="/Abstract elements/Brown shape 1.svg" className="-right-28 -top-20 w-[400px] h-[400px]" opacity={0.9} />
        <AbstractDeco src="/Abstract elements/Leaf1.svg" className="-left-20 bottom-10 w-[300px] h-[300px]" opacity={0.9} style={{ transform: 'rotate(-30deg)' }} />
        ...
        <div className="max-w-[1000px] mx-auto relative z-10">
          <FadeUp>
            <div className="rounded-[2rem] p-8 md:p-10 border border-[hsl(35_40%_70%)]/40 shadow-[0_4px_20px_hsl(30_15%_80%_/_0.15)] relative overflow-hidden" style={{ background: 'linear-gradient(135deg, hsl(40 40% 92%) 0%, hsl(35 35% 88%) 100%)' }}>
              <AbstractDeco src="/Abstract elements/Teal shape 1.svg" className="-right-16 -top-10 w-[200px] h-[200px]" opacity={0.2} />
      ...
      <section className="bg-card py-24 lg:py-32 relative overflow-hidden">
        <AbstractDeco src="/Abstract elements/Teal shape 2.svg" className="-left-32 -bottom-20 w-[450px] h-[450px]" opacity={0.9} />
        <AbstractDeco src="/Abstract elements/Leaf2.svg" className="-right-20 top-16 w-[280px] h-[280px]" opacity={0.9} style={{ transform: 'rotate(15deg)' }} />
      ...
      <section className="bg-background py-24 lg:py-32 relative overflow-hidden">
        <AbstractDeco src="/Abstract elements/Brown shape 2.svg" className="left-1/3 -top-20 w-[350px] h-[350px]" opacity={0.9} />
      ...
      <section className="py-24 lg:py-32 relative overflow-hidden" style={{ background: 'linear-gradient(170deg, hsl(175 30% 92%) 0%, hsl(40 30% 97%) 100%)' }}>
        <AbstractDeco src="/Abstract elements/Leaf1.svg" className="-right-16 -top-10 w-[300px] h-[300px]" opacity={0.9} style={{ transform: 'rotate(30deg)' }} />
      ...
      <section className="bg-background py-24 lg:py-32 relative overflow-hidden">
        <AbstractDeco src="/Abstract elements/Teal shape 2.svg" className="-right-32 -top-20 w-[400px] h-[400px]" opacity={0.9} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-16 items-center">
            ...
            <FadeUp delay={0.15}>
              <div className="relative mx-auto">
                <AbstractDeco src="/Abstract elements/Brown shape 2.svg" className="-right-10 -bottom-10 w-[250px] h-[250px]" opacity={0.9} />
                {/* Squircle shape */}
      ...
      <section className="bg-card py-24 lg:py-32 relative overflow-hidden">
        <AbstractDeco src="/Abstract elements/Teal shape 1.svg" className="-left-32 -top-16 w-[400px] h-[400px]" opacity={0.9} />
      ...
      <section className="relative overflow-hidden py-24 lg:py-28 px-6" style={{ background: 'hsl(175 35% 55%)' }}>
        ...
        <AbstractDeco src="/Abstract elements/Leaf2.svg" className="-left-20 -top-16 w-[300px] h-[300px]" opacity={0.12} style={{ filter: 'brightness(0) invert(1)' }} />
        <AbstractDeco src="/Abstract elements/Brown shape 1.svg" className="-right-16 -bottom-20 w-[350px] h-[350px]" opacity={0.08} style={{ filter: 'brightness(0) invert(1)' }} />

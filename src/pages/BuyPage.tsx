  ...
  return (
    <>
      ...
      <section className="bg-background py-24 lg:py-32 relative overflow-hidden">
        <AbstractDeco src="/Abstract elements/Leaf1.svg" className="-right-20 -top-10 w-[300px] h-[300px]" opacity={0.9} style={{ transform: 'rotate(20deg)' }} />
        <AbstractDeco src="/Abstract elements/Teal shape 2.svg" className="-left-32 bottom-10 w-[400px] h-[400px]" opacity={0.9} />
      ...
      <section className="py-24 lg:py-32 relative overflow-hidden" style={{ background: 'linear-gradient(170deg, hsl(175 30% 92%) 0%, hsl(40 30% 97%) 100%)' }}>
        <AbstractDeco src="/Abstract elements/Brown shape 1.svg" className="-right-28 -top-16 w-[350px] h-[350px]" opacity={0.9} />
        <AbstractDeco src="/Abstract elements/Leaf2.svg" className="-left-16 bottom-20 w-[280px] h-[280px]" opacity={0.9} style={{ transform: 'rotate(20deg)' }} />
      ...
      <section className="bg-background py-16 lg:py-20 px-6 relative overflow-hidden">
        <AbstractDeco src="/Abstract elements/Brown shape 2.svg" className="-left-20 -bottom-16 w-[300px] h-[300px]" opacity={0.9} />
        ...
        <div className="max-w-[800px] mx-auto px-6 lg:px-10 relative z-10">
          <FadeUp>
            <div className="rounded-[2rem] p-8 md:p-10 border border-[hsl(35_40%_70%)]/40 shadow-[0_4px_20px_hsl(30_15%_80%_/_0.15)] relative overflow-hidden" style={{ background: 'linear-gradient(135deg, hsl(40 40% 92%) 0%, hsl(35 35% 88%) 100%)' }}>
              <AbstractDeco src="/Abstract elements/Leaf1.svg" className="-right-10 -bottom-8 w-[180px] h-[180px]" opacity={0.25} style={{ transform: 'rotate(-20deg)' }} />

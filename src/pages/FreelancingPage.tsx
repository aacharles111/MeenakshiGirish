  ...
  return (
    <>
      ...
      <section className="bg-background py-24 lg:py-32 relative overflow-hidden">
        <AbstractDeco src="/Abstract elements/Brown shape 1.svg" className="-right-32 -top-20 w-[350px] h-[350px]" opacity={0.9} />
        <AbstractDeco src="/Abstract elements/Teal shape 2.svg" className="-left-28 bottom-10 w-[400px] h-[400px]" opacity={0.9} />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[350px_1fr] gap-16 items-center">
            ...
            <FadeUp>
              <div className="relative mx-auto lg:mx-0">
                <AbstractDeco src="/Abstract elements/Leaf2.svg" className="-left-14 -top-10 w-[280px] h-[280px]" opacity={0.9} style={{ transform: 'rotate(20deg)' }} />
      ...
      <section className="bg-card py-24 lg:py-32 relative overflow-hidden">
        <AbstractDeco src="/Abstract elements/Teal shape 1.svg" className="-right-40 -bottom-32 w-[500px] h-[500px]" opacity={0.9} />
        <AbstractDeco src="/Abstract elements/Brown shape 2.svg" className="-left-24 top-1/4 w-[300px] h-[300px]" opacity={0.9} />
      ...
      <section className="py-24 lg:py-32 relative overflow-hidden" style={{ background: 'linear-gradient(170deg, hsl(175 30% 92%) 0%, hsl(40 30% 97%) 50%, hsl(40 30% 97%) 100%)' }}>
        <AbstractDeco src="/Abstract elements/Leaf1.svg" className="-left-16 -top-10 w-[300px] h-[300px]" opacity={0.9} style={{ transform: 'rotate(-30deg)' }} />
        <AbstractDeco src="/Abstract elements/Teal shape 2.svg" className="-right-20 bottom-0 w-[350px] h-[350px]" opacity={0.9} />
      ...
      <section className="bg-background py-24 lg:py-32 relative overflow-hidden">
        <AbstractDeco src="/Abstract elements/Brown shape 1.svg" className="-left-32 -top-24 w-[400px] h-[400px]" opacity={0.9} />
      ...
      <section className="bg-card py-24 lg:py-32 relative overflow-hidden">
        <AbstractDeco src="/Abstract elements/Teal shape 1.svg" className="-right-28 top-20 w-[380px] h-[380px]" opacity={0.9} />
        <AbstractDeco src="/Abstract elements/Leaf1.svg" className="-left-20 -bottom-16 w-[300px] h-[300px]" opacity={0.9} style={{ transform: 'rotate(-15deg)' }} />
      ...
      <section className="relative overflow-hidden py-24 lg:py-28 px-6" style={{ background: 'hsl(175 35% 55%)' }}>
        ...
        <AbstractDeco src="/Abstract elements/Brown shape 1.svg" className="-left-20 -top-16 w-[300px] h-[300px]" opacity={0.12} style={{ filter: 'brightness(0) invert(1)' }} />
        <AbstractDeco src="/Abstract elements/Leaf2.svg" className="-right-16 -bottom-20 w-[350px] h-[350px]" opacity={0.08} style={{ filter: 'brightness(0) invert(1)', transform: 'rotate(15deg)' }} />

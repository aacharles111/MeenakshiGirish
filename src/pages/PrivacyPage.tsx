    ...
    <LegalLayout
      ...
      sections={[
        { h: 'What I Collect', p: [
          ...
          <>Payments are processed by Razorpay, the payment processor, which handles your card, UPI, and banking details — I never see or store that information. See Razorpay&rsquo;s <a href="https://razorpay.com/privacy-policy/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Privacy Policy</a> and <a href="https://razorpay.com/tnc/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Terms of Use</a>.</>,
        ]},
        { h: 'How I Use It', p: [

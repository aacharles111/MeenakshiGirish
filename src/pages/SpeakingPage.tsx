  ...
  return (
    <>
      ...
      <section className="bg-background py-24 lg:py-32 relative overflow-hidden">
        <AbstractDeco src="/Abstract elements/Brown shape 2.svg" className="-left-32 bottom-10 w-[400px] h-[400px]" opacity={0.9} />
        <AbstractDeco src="/Abstract elements/Leaf2.svg" className="-right-16 -top-10 w-[280px] h-[280px]" opacity={0.9} style={{ transform: 'rotate(-20deg)' }} />
      ...
      <section className="bg-card py-24 lg:py-32 relative overflow-hidden">
        <AbstractDeco src="/Abstract elements/Teal shape 1.svg" className="-right-40 -bottom-32 w-[450px] h-[450px]" opacity={0.9} />
        <AbstractDeco src="/Abstract elements/Brown shape 1.svg" className="-left-24 top-16 w-[300px] h-[300px]" opacity={0.9} />
        ...
        <div className="max-w-[800px] mx-auto px-6 lg:px-10 relative z-10">
          <FadeUp>
            <div className="rounded-[2rem] p-8 md:p-10 border border-[hsl(35_40%_70%)]/40 shadow-[0_4px_20px_hsl(30_15%_80%_/_0.15)] text-center relative overflow-hidden" style={{ background: 'linear-gradient(135deg, hsl(40 40% 92%) 0%, hsl(35 35% 88%) 100%)' }}>
              <AbstractDeco src="/Abstract elements/Leaf2.svg" className="-right-12 -bottom-10 w-[200px] h-[200px]" opacity={0.3} style={{ transform: 'rotate(25deg)' }} />
      ...
      <section className="bg-card py-24 lg:py-32 relative overflow-hidden">
        <AbstractDeco src="/Abstract elements/Teal shape 2.svg" className="-left-32 -top-20 w-[400px] h-[400px]" opacity={0.9} />
      ...
      <section className="relative overflow-hidden py-24 lg:py-28 px-6" style={{ background: 'hsl(175 35% 55%)' }}>
        ...
        <AbstractDeco src="/Abstract elements/Leaf1.svg" className="-left-20 -top-16 w-[300px] h-[300px]" opacity={0.12} style={{ filter: 'brightness(0) invert(1)' }} />
